package com.ace.ucv.wonderful.places.utils
...
class GetAddressFromLatLng(context: Context, private val latitude: Double,
     ...
     */
    private lateinit var mapAddressListener: AddressListener
    ...
    override fun doInBackground(vararg params: Void?): String {
        try {
            ...
            Log.e("WonderfulPlaces", "Unable connect to Geocoder")
        }
    ...
    /**
     * onPostExecute method of AsyncTask where the result will be received and assigned
     * to the interface accordingly.
     */
    override fun onPostExecute(resultString: String?) {
        if (resultString == null) {
            mapAddressListener.onError()
        } else {
            mapAddressListener.onAddressFound(resultString)
        }
    ...
    fun setAddressListener(addressListener: AddressListener) {
        mapAddressListener = addressListener
    }
